...
> [!summary]+   **引入**
> $Qs1:$
> $$能否\textcolor{orange}{\underline{\textbf{找到一组基}}}\quad S.t. \quad \mathscr{A}在\textcolor{pink}{\underline{\textbf{基}}}下的\textcolor{orange}{\underline{\textbf{矩阵}}}具有\textcolor{orange}{\underline{\textbf{对角形}}}?$$
...
> [!summary]+ **引入**
> $$到底如何计算\textcolor{orange}{\underline{\textbf{线性变换}}}\mathscr{A}的\textcolor{pink}{\underline{\textbf{特征值}}}和\textcolor{pink}{\underline{\textbf{特征向量}}}呢?$$
...
1. [[定理 4.2]] (  $A \textcolor{red}{\underline{\textbf{可对角化}}}\quad \Leftrightarrow \quad V=V_{\lambda_{1}}\oplus \cdots \oplus V_{\lambda_{k}}$  ) #高代上/第四章/重要定理 
	- **2个先决条件**
		1. $\mathbb{A} \in End(V)$
		2. $\dim V(\mathbb{K}) = n$
	- **<font color="#de7802">1个条件</font>**
...
> $$\Downarrow$$
> $$下面进行推广 \quad \Leftrightarrow \quad \textcolor{pink}{\underline{\textbf{若干个}}}\textcolor{orange}{\underline{\textbf{不变子空间}}}的\textcolor{red}{\underline{\textbf{直和}}}可以吗?$$
...
1. [[命题 4.6]] (  $\mathscr{A}的\textcolor{pink}{\underline{\textbf{矩阵}}}A \textcolor{red}{\underline{\textbf{可对角化}}} \quad \Rightarrow \quad \forall \ \mathscr{A}的\textcolor{orange}{\underline{\textbf{不变子空间}}}M \ , \  \mathscr{A}|_{M}\textcolor{red}{\underline{\textbf{可对角化}}}$  ) #高代上/第四章/重要命题 
	- **<font color="#ee5198">2个先决条件</font>**
		1. $\mathscr{A}\in End(V)$
		2. $\dim V(\mathbb{K}) = n$
	- **解释**
